...
class PropertiesController extends Controller
{
    ...
    public function actionEditProperty($property_group_id, $id = null)
    {
        ...
        $object = Objects::getForClass(Property::className());
    ...
    public function actionEditStaticValue($property_id, $id = null)
    {
        ...
        $object = Objects::getForClass(PropertyStaticValues::className());
        ...
        if (Yii::$app->request->isPost) {
            if ($model->load(Yii::$app->request->post()) && $model->save()) {
                ...
                if (!is_null($objectId) && !is_null($objectModelId)) {
                    ...
                    $tags[] = ActiveRecordHelper::getCommonTag(Objects::findById($objectId)->object_class);
                    $tags[] = ActiveRecordHelper::getObjectTag(
                        Objects::findById($objectId)->object_class,
                        $objectModelId
                    );
                }
