...
class m150602_095853_openGraphObject extends Migration
{
    public function up()
    {
        ...
        $this->batchInsert(
            ...
            [
                [
                    \app\models\Objects::getForClass(\app\modules\page\models\Page::className())->id,
                    1,
                    json_encode($data)
                ],
                [
                    \app\models\Objects::getForClass(\app\modules\shop\models\Category::className())->id,
                    1,
                    json_encode($data)
                ],
                [
                    \app\models\Objects::getForClass(\app\modules\shop\models\Product::className())->id,
                    1,
                    json_encode($data)
                ],
