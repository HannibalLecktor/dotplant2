    ...
    DynaGrid::widget(
        [
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'object_id',
                    'filter' => \app\components\Helper::getModelMap(\app\models\Objects::className(), 'id', 'name'),
                    'label' => Yii::t('app', 'Object'),
                    'value' => function ($data) {
                        $obj = \app\models\Objects::findById($data->object_id);
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        if (null !== $object = \app\models\Objects::findById($data->object_id)) {
