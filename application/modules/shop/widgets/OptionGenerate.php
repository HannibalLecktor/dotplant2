...
class OptionGenerate extends Widget
{
    ...
    public function run()
    {
        ...
        $optionGenerate = ($this->model->option_generate)? Json::decode($this->model->option_generate) : [];
        if (isset($optionGenerate['group']) && null === PropertyGroup::findOne($optionGenerate['group'])) {
